...
final class ViewController: UIViewController {
    ...
    private var operating = false                    // Nos indicará si se ha seleccionado un operador
    private var decimal = false                      // Nos indicará si el valor es decimal
    ...
    @IBAction func operatorPercentAction(_ sender: UIButton) {
        ...
        // En operation indicamo la operación
        operating = true
        operation = .percent
        result()
    ...
    @IBAction func numberAction(_ sender: UIButton) {
        ...
        // Si se ha pulsado un número lo primero que hacemos es cambiar el titulo de AC a C
        operatorAC.setTitle("C", for: .normal)
        // Controlamos que no introduscan mán de 9 números
